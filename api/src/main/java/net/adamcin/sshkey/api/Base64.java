...
/* ********  P R I V A T E   F I E L D S  ******** */
    ...
    /** Preferred encoding. */
    private final static String PREFERRED_ENCODING = Constants.CHARSET.name(); //"US-ASCII";
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
     ...
     * @since 2.3
     */
    private static void encode( java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded ){
     ...
     * @since 2.3
     */
    private static void encode( java.nio.ByteBuffer raw, java.nio.CharBuffer encoded ){
        byte[] raw3 = new byte[3];
        byte[] enc4 = new byte[4];
     ...
     * @since 2.0
     */
    private static String encodeBytes( byte[] source, int options ) throws java.io.IOException {
     ...
     * @since 2.3.1
     */
    private static byte[] encodeBytesToBytes( byte[] source ) {
        byte[] encoded = null;
        try {
...
//        }
     ...
     * @since 1.4
     */
    private static byte[] decode( String s ) throws java.io.IOException {
     ...
     * @since 1.5
     */
    private static Object decodeToObject( String encodedObject )
     ...
     * @since 2.1
     */
    private static void encodeToFile( byte[] dataToEncode, String filename )
            throws java.io.IOException {
     ...
     * @since 2.2
     */
    private static void encodeFileToFile( String infile, String outfile )
            throws java.io.IOException {
     ...
     * @since 2.2
     */
    private static void decodeFileToFile( String infile, String outfile )
            throws java.io.IOException {
    ...
    private static class InputStream extends java.io.FilterInputStream {
         ...
         * @since 1.3
         */
        private InputStream( java.io.InputStream in ) {
            this( in, DECODE );
        }   // end constructor
    ...
    private static class OutputStream extends java.io.FilterOutputStream {
         ...
         * @since 1.3
         */
        private OutputStream( java.io.OutputStream out ) {
            this( out, ENCODE );
        }   // end constructor
         ...
         * @since 1.5.1
         */
        private void suspendEncoding() throws java.io.IOException  {
            flushBase64();
