...
/**
 * Default {@link net.adamcin.sshkey.api.Identity} implementation for OpenSSH-compliant keys (RSA/DSA)
 */
public final class JCEIdentity implements Identity {
    private static final Logger LOGGER = LoggerFactory.getLogger(JCEIdentity.class);
    ...
    public JCEIdentity(KeyFormat keyFormat, KeyPair keyPair) {
        if (keyFormat == null) {
    ...
    public JCEIdentity(KeyFormat keyFormat, PublicKey publicKey,
    ...
    public boolean equals(Object o) {
        ...
        JCEIdentity that = (JCEIdentity) o;
