...
import net.adamcin.sshkey.api.*;
import net.adamcin.sshkey.provider.KeyTestUtil;
...
public class PublicKeyTest {
    ...
    public void roundTrip(Challenge challenge, String sessionId, String parentName, String keyName, String passphrase)
        ...
        byte[] sig = sign(challenge.getHash(), parentName, keyName, passphrase);
    ...
    public byte[] sign(byte[] data, String parentName, String keyName, String passphrase) {
